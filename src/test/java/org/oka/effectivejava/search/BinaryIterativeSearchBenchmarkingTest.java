...
public class BinaryIterativeSearchBenchmarkingTest {
    ...
    public void shouldProduceBenchmarking(final int size) {
        // Given
        Search linearSearch = new BinaryIterativeSearch();

        // When
        double totalTime = searchBenchmarker.search(linearSearch, size);

        // Then
        System.out.println("BinaryIterativeSearch execution time (" + size + "): " + (totalTime) + " ms.");
    }
}
